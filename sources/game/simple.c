...
void Simple2048() {
  ...
  // These two numbers will be used for the sake of finding an empty tile, see
  // below:
  int RandomX = rand() % 4;
  int RandomY = rand() % 4;

  // This is the loop for the game. As of the current version, it doesn't have a
  // "fail condition".
  while (1) {
    ...
    printf("\nEnter your input:");
    printf("\n'u' for Up-to-Down, 'd' for Down-to-Up, 'l' for Left-to-Right, "
           "and 'r' for Right-to-Left\n");
